"use strict";(()=>{var D=(e,t,s)=>()=>{if(s)throw s[0];try{return e&&(t=e(e=0)),t}catch(a){throw s=[a],a}};var H=(e,t)=>()=>{try{return t||e((t={exports:{}}).exports,t),t.exports}catch(s){throw t=0,s}};var R,F,N=D(()=>{R=["owl2rl-eyeling.n3","shacl-core-eyeling.n3","skos-entailment.n3"],F=`# Source: rules/owl2rl-eyeling.n3
...
=> { ?left skos:exactMatch ?right . } .`});var x,q=D(()=>{x=[{id:"owl-skos-catalog",label:"Catalog topics (OWL 2 RL + SKOS Core)",backgroundFile:"examples/owl-skos-catalog/ontology.n3",dataFile:"examples/owl-skos-catalog/input.trig",background:`# Combined OWL 2 RL + SKOS Core example background.
#
