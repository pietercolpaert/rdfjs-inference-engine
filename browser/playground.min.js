...
=> { ?left skos:exactMatch ?right . } .`});var x,q=_(()=>{x=[{id:"owl-skos-catalog",label:"Catalog topics (OWL 2 RL + SKOS Core)",backgroundFile:"examples/owl-skos-catalog/ontology.n3",dataFile:"examples/owl-skos-catalog/input.trig",background:`# Combined OWL 2 RL + SKOS Core example background.
#
