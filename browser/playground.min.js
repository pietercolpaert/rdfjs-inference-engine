"use strict";(()=>{var B=(e,t,r)=>()=>{if(r)throw r[0];try{return e&&(t=e(e=0)),t}catch(a){throw r=[a],a}};var re=(e,t)=>()=>{try{return t||e((t={exports:{}}).exports,t),t.exports}catch(r){throw t=0,r}};var M,T,Le,V=B(()=>{M=["owl2rl-eyeling.n3","skos-entailment.n3"],T=[{file:"owl2rl-eyeling.n3",n3:`# Source: rules/owl2rl-eyeling.n3
...
=> { ?left skos:exactMatch ?right . } .`}],Le=T.map(e=>e.n3).join(`

`)});var k,z=B(()=>{k=[{id:"owl-skos-catalog",label:"Catalog topics (OWL 2 RL + SKOS Core)",backgroundFile:"examples/owl-skos-catalog/ontology.n3",dataFile:"examples/owl-skos-catalog/input.trig",background:`# Combined OWL 2 RL + SKOS Core example background.
#
...
`}]});var Pe=re(()=>{V();z();var u={backgroundMode:"text",dataMode:"text",backgroundText:w().background,dataText:w().data},s={backgroundText:y("backgroundText",u.backgroundText),dataText:y("dataText",u.dataText),shaclInText:y("shaclInText",""),shaclOutText:y("shaclOutText",""),outputText:y("outputText","")},R=y("generatedRuntimeText","",{readOnly:!0}),n={exampleSelect:F("exampleSelect"),backgroundMode:F("backgroundMode"),dataMode:F("dataMode"),statefulMaterialization:A("statefulMaterialization"),backgroundUrl:A("backgroundUrl"),dataUrl:A("dataUrl"),backgroundUrlPanel:c("backgroundUrlPanel"),backgroundTextPanel:c("backgroundTextPanel"),dataUrlPanel:c("dataUrlPanel"),dataTextPanel:c("dataTextPanel"),shapeHintsPanel:c("shapeHintsPanel"),generatedRuntimePanel:c("generatedRuntimePanel"),runButton:I("runButton"),stopButton:I("stopButton"),resetButton:I("resetButton"),shareButton:I("shareButton"),status:c("status"),runtimeStats:c("runtimeStats"),rulesSummary:G("rulesSummary"),ruleProfileList:G("ruleProfileList")},m=!1,U=0,h=null,b="",f=0;be();ve();Ie();P();oe();x();_(!1);g("Ready. Choose an example, URL, or text input, then run inference.");function y(e,t,r={}){let a=document.getElementById(e);if(!a)throw new Error(`Missing textarea #${e}`);return a.value=t,CodeMirror.fromTextArea(a,{mode:"text/turtle",lineNumbers:!0,lineWrapping:!0,tabSize:2,viewportMargin:1/0,...r})}function se(){R.setValue(""),n.generatedRuntimePanel.open=!1,n.generatedRuntimePanel.hidden=!0}function ae(e){R.setValue(e),n.generatedRuntimePanel.hidden=!1,window.setTimeout(()=>R.refresh(),0)}function oe(){n.runButton.addEventListener("click",()=>{le()}),n.stopButton.addEventListener("click",ue),n.resetButton.addEventListener("click",xe),n.exampleSelect.addEventListener("change",()=>ke(n.exampleSelect.value)),n.shareButton.addEventListener("click",()=>{E(),navigator.clipboard?.writeText(window.location.href),g("Shareable URL copied when clipboard access is available.")});for(let e of[n.backgroundMode,n.dataMode])e.addEventListener("change",()=>{P(),x()});for(let e of Object.values(s))e.on("change",x);n.shapeHintsPanel.addEventListener("toggle",()=>{window.setTimeout(()=>{s.shaclInText.refresh(),s.shaclOutText.refresh()},0)}),n.generatedRuntimePanel.addEventListener("toggle",()=>{window.setTimeout(()=>R.refresh(),0)});for(let e of[n.backgroundUrl,n.dataUrl])e.addEventListener("input",x);n.statefulMaterialization.addEventListener("change",x)}async function le(){if(h)return;let e={controller:new AbortController,startedAt:performance.now()};h=e;try{_(!0),n.runtimeStats.textContent="",n.runtimeStats.hidden=!0,se(),q(),me(e),s.outputText.setValue(""),K(e,"Preparing inference\u2026");let t=await ce("background",e.controller.signal);ye(e.controller.signal);let r=p("data"),a=r==="text"?s.dataText.getValue():void 0,o=r==="url"?n.dataUrl.value.trim():void 0,i=s.shaclInText.getValue().trim()||void 0,d=s.shaclOutText.getValue().trim()||void 0;if(r==="url"&&!o)throw new Error("Enter a data URL or switch to text input.");let l=J();if(l.length===0)throw new Error("Select at least one bundled N3 rule file in the advanced rule profile selection.");await ie(e,{apiScriptUrl:new URL("browser/rdfjs-inference-engine.min.js",window.location.href).href,bundledRules:l.map(L=>L.n3).join(`

`),bundledRuleProfiles:l,bundledRuleCount:l.length,bundledRuleLabels:l.map(L=>L.file),backgroundSource:t,dataMode:r,statefulMaterialization:n.statefulMaterialization.checked,statefulStoreName:n.statefulMaterialization.checked?de(t,r==="url"?o??"":a??""):void 0,shaclInSource:i,shaclOutSource:d,dataSource:a,dataUrl:o})}catch(t){if(he(t))W(),e.statusMessage="Stopped. No more messages or quads will be processed.";else{let r=t instanceof Error?t.message:String(t);q(),e.statusMessage=`Error: ${r}`,s.outputText.setValue(r)}D(e)}finally{D(e),h===e&&(h=null),e.worker?.terminate(),_(!1)}}function ie(e,t){return new Promise((r,a)=>{let o=pe();e.worker=o;let i=()=>{o.terminate(),a(new DOMException("Inference was stopped.","AbortError"))};e.controller.signal.addEventListener("abort",i,{once:!0}),o.onmessage=d=>{let l=d.data;l.type==="status"?K(e,l.message):l.type==="runtime"?(e.runtimeMessage=l.message,l.runtime!==void 0&&ae(l.runtime),C(e)):l.type==="append"?fe(l.chunk):l.type==="result"?(e.statusMessage=l.status,l.output!==void 0?(q(),s.outputText.setValue(l.output)):W(),D(e),r()):l.type==="error"&&a(new Error(l.message))},o.onerror=d=>{a(new Error(d.message))},o.postMessage(t)})}function de(e,t){let r=[window.location.origin,window.location.pathname,e,t].join("\0");return`rdfjs-inference-engine:playground:${X(r)}`}function X(e){let t=3735928559,r=1103547991;for(let a=0;a<e.length;a+=1){let o=e.charCodeAt(a);t=Math.imul(t^o,2654435761),r=Math.imul(r^o,1597334677)}return t=Math.imul(t^t>>>16,2246822507)^Math.imul(r^r>>>13,3266489909),r=Math.imul(r^r>>>16,2246822507)^Math.imul(t^t>>>13,3266489909),`${(r>>>0).toString(36)}${(t>>>0).toString(36)}`}function pe(){let e=`
...
`,t=new Blob([e],{type:"text/javascript"});return new Worker(URL.createObjectURL(t))}async function ce(e,t){if(p(e)==="text")return e==="background"?s.backgroundText.getValue():s.dataText.getValue();let o=(e==="background"?n.backgroundUrl:n.dataUrl).value.trim();if(!o)throw new Error(`Enter a ${e==="background"?"background RDF":"data"} URL or switch to text input.`);g(`Fetching ${e==="background"?"background RDF":"input data"} before processing\u2026`);let i=await fetch(o,{signal:t});if(!i.ok)throw new Error(`Could not fetch ${o}: ${i.status} ${i.statusText}`);return i.text()}function ue(){h&&(g("Stopping after the current worker step\u2026"),n.stopButton.disabled=!0,h.controller.abort())}function _(e){n.runButton.disabled=e,n.stopButton.hidden=!e,n.stopButton.disabled=!e}function K(e,t){e.statusMessage=t,$(e)}function me(e){C(e),e.elapsedTimer=window.setInterval(()=>C(e),250)}function D(e){e.finishedAt===void 0&&(e.finishedAt=performance.now()),e.elapsedTimer!==void 0&&(window.clearInterval(e.elapsedTimer),e.elapsedTimer=void 0),C(e)}function C(e){n.runtimeStats.textContent="",n.runtimeStats.hidden=!0,$(e)}function $(e){if(!e.statusMessage)return;let t=e.finishedAt===void 0?"Elapsed":"Total elapsed",r=[H(e.statusMessage),`${t} ${ge(we(e))}`];e.runtimeMessage&&r.push(H(e.runtimeMessage)),g(r.filter(Boolean).join(" \xB7 "))}function H(e){return e.trim().replace(/[.。]\s*$/,"")}function fe(e){b+=e,f||(f=window.setTimeout(W,100))}function W(){if(f&&(window.clearTimeout(f),f=0),!b)return;let e=b;if(b="",s.outputText.replaceRange&&s.outputText.lastLine&&s.outputText.getLine){let t=s.outputText.lastLine();s.outputText.replaceRange(e,{line:t,ch:s.outputText.getLine(t).length})}else s.outputText.setValue(s.outputText.getValue()+e)}function q(){f&&(window.clearTimeout(f),f=0),b=""}function we(e){return(e.finishedAt??performance.now())-e.startedAt}function ge(e){let t=Math.max(0,e/1e3);if(t<10)return`${t.toFixed(1)} s`;if(t<60)return`${t.toFixed(0)} s`;let r=Math.floor(t/60),a=Math.floor(t%60).toString().padStart(2,"0");return`${r} min ${a} s`}function ye(e){if(e.aborted)throw new DOMException("Inference was stopped.","AbortError")}function he(e){return e instanceof DOMException&&e.name==="AbortError"}function P(){S(n.backgroundUrlPanel,p("background")==="url"),S(n.backgroundTextPanel,p("background")==="text"),S(n.dataUrlPanel,p("data")==="url"),S(n.dataTextPanel,p("data")==="text"),window.setTimeout(()=>{s.backgroundText.refresh(),s.dataText.refresh(),s.shaclInText.refresh(),s.shaclOutText.refresh(),s.outputText.refresh()},0)}function S(e,t){e.hidden=!t}function p(e){return(e==="background"?n.backgroundMode.value:n.dataMode.value)==="url"?"url":"text"}function xe(){let e=w();m=!0,n.exampleSelect.value=e.id,n.backgroundMode.value=u.backgroundMode,n.dataMode.value=u.dataMode,n.statefulMaterialization.checked=!1,n.backgroundUrl.value="",n.dataUrl.value="",N([]),s.backgroundText.setValue(e.background),s.dataText.setValue(e.data),s.shaclInText.setValue(e.shaclIn??""),s.shaclOutText.setValue(e.shaclOut??""),n.shapeHintsPanel.open=!!(e.shaclIn||e.shaclOut),s.outputText.setValue(""),m=!1,P(),E(),g(`Reset to ${e.label}.`)}function be(){n.exampleSelect.textContent="";for(let e of k){let t=document.createElement("option");t.value=e.id,t.textContent=`${e.label} \u2014 ${Q(e)}`,n.exampleSelect.appendChild(t)}n.exampleSelect.value=w().id}function Q(e){let t=[e.backgroundFile,e.dataFile];return e.shaclInFile&&t.push(e.shaclInFile),e.shaclOutFile&&t.push(e.shaclOutFile),t.join(" + ")}function ve(){if(!n.ruleProfileList){O();return}n.ruleProfileList.textContent="";for(let e of T){let t=Te(e.file),r=`ruleProfile-${X(e.file)}`,a=document.createElement("div");a.className="rule-profile-option";let o=document.createElement("input");o.type="checkbox",o.id=r,o.checked=!0,o.dataset.ruleFile=e.file,o.addEventListener("change",()=>{O(),x()});let i=document.createElement("div");i.className="rule-profile-copy";let d=document.createElement("label");d.htmlFor=r,d.textContent=t.label;let l=document.createElement("span");l.className="hint",l.textContent=t.description,i.append(d,l),a.append(o,i),n.ruleProfileList.appendChild(a)}O()}function Te(e){return{"owl2rl-eyeling.n3":{label:"OWL 2 RL / RDF rules",description:"Materializes OWL 2 RL and RDFS-style consequences such as subclass, subproperty, domain/range, equivalence, property chains, selected restrictions, sameAs, and inconsistency diagnostics."},"skos-entailment.n3":{label:"SKOS Core entailment rules",description:"Materializes SKOS Core consequences such as concept-scheme membership, broader/narrower inverses and transitive closures, semantic relation hierarchy, labels, notes, collections, and mapping properties."}}[e]??{label:e,description:"Additional bundled N3 rule profile loaded from the repository rules folder."}}function Z(){return n.ruleProfileList?Array.from(n.ruleProfileList.querySelectorAll('input[type="checkbox"][data-rule-file]')):[]}function J(){let e=new Set(ee());return T.filter(t=>!e.has(t.file))}function ee(){return Z().filter(e=>!e.checked).map(e=>e.dataset.ruleFile??"").filter(Boolean).sort()}function N(e){let t=new Set(e);for(let r of Z())r.checked=!t.has(r.dataset.ruleFile??"");O()}function O(){if(!n.rulesSummary)return;let e=J().map(t=>t.file);e.length===M.length?n.rulesSummary.textContent=`Rule profiles: all ${e.length} enabled`:e.length===0?n.rulesSummary.textContent="Rule profiles: none enabled":n.rulesSummary.textContent=`Rule profiles: ${e.length}/${M.length} enabled`}function ke(e){let t=v(e)??w();m=!0,j(t),m=!1,P(),E(),g(`Loaded ${t.label} from ${Q(t)}.`)}function j(e){n.exampleSelect.value=e.id,n.backgroundMode.value="text",n.dataMode.value="text",n.statefulMaterialization.checked=te(e.id),n.backgroundUrl.value="",n.dataUrl.value="",s.backgroundText.setValue(e.background),s.dataText.setValue(e.data),s.shaclInText.setValue(e.shaclIn??""),s.shaclOutText.setValue(e.shaclOut??""),n.shapeHintsPanel.open=!!(e.shaclIn||e.shaclOut),s.outputText.setValue("")}function te(e){return e==="stateful-materialization"}function w(){return v("owl-skos-catalog")??k[0]}function v(e){return k.find(t=>t.id===e)}function Se(){let e=v(n.exampleSelect.value),t=ee();if(e&&Y(e)&&t.length===0)return e.id===w().id?{}:{example:e.id};let r={disabledRuleFiles:t.length>0?t:void 0,backgroundMode:p("background")===u.backgroundMode?void 0:p("background"),dataMode:p("data")===u.dataMode?void 0:p("data"),statefulMaterialization:n.statefulMaterialization.checked||void 0,backgroundUrl:n.backgroundUrl.value.trim()||void 0,dataUrl:n.dataUrl.value.trim()||void 0},a=s.backgroundText.getValue(),o=s.dataText.getValue(),i=s.shaclInText.getValue(),d=s.shaclOutText.getValue();return e&&Y(e)&&e.id!==w().id&&(r.example=e.id),!r.example&&a!==u.backgroundText&&(r.backgroundText=a),!r.example&&o!==u.dataText&&(r.dataText=o),i.trim()&&(r.shaclInText=i),d.trim()&&(r.shaclOutText=d),r}function Y(e){return p("background")==="text"&&p("data")==="text"&&n.statefulMaterialization.checked===te(e.id)&&n.backgroundUrl.value.trim()===""&&n.dataUrl.value.trim()===""&&s.backgroundText.getValue()===e.background&&s.dataText.getValue()===e.data&&s.shaclInText.getValue()===(e.shaclIn??"")&&s.shaclOutText.getValue()===(e.shaclOut??"")}function Ie(){let e=Re(window.location.hash);if(e){let r=v(e);if(r){m=!0,j(r),N([]),m=!1;return}}let t=Ce(window.location.hash);if(t){if(m=!0,t.example){let r=v(t.example);r&&j(r)}n.backgroundMode.value=t.backgroundMode??u.backgroundMode,n.dataMode.value=t.dataMode??u.dataMode,t.statefulMaterialization!==void 0&&(n.statefulMaterialization.checked=t.statefulMaterialization),n.backgroundUrl.value=t.backgroundUrl??"",n.dataUrl.value=t.dataUrl??"",t.backgroundText!==void 0&&s.backgroundText.setValue(t.backgroundText),t.dataText!==void 0&&s.dataText.setValue(t.dataText),t.shaclInText!==void 0&&(s.shaclInText.setValue(t.shaclInText),n.shapeHintsPanel.open=!0),t.shaclOutText!==void 0&&(s.shaclOutText.setValue(t.shaclOutText),n.shapeHintsPanel.open=!0),N(t.disabledRuleFiles??[]),m=!1}}function x(){m||(window.clearTimeout(U),U=window.setTimeout(E,400))}function E(){let e=Oe(Se()),t=`${window.location.pathname}${window.location.search}${e?`#${e}`:""}`;window.history.replaceState(null,"",t)}function Oe(e){if(e.example&&Object.keys(e).length===1)return`example=${encodeURIComponent(e.example)}`;let t=JSON.stringify(e);return t==="{}"?"":`state=${btoa(unescape(encodeURIComponent(t))).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/g,"")}`}function Re(e){let t=ne(e,"#example=");if(!t)return"";try{return decodeURIComponent(t)}catch{return""}}function Ce(e){let t=ne(e,"#state=");if(!t)return null;try{let r=t.replace(/-/g,"+").replace(/_/g,"/").padEnd(Math.ceil(t.length/4)*4,"=");return JSON.parse(decodeURIComponent(escape(atob(r))))}catch{return null}}function ne(e,t){if(!e.startsWith(t))return"";let r=e.slice(t.length),a=r.indexOf("?");return a===-1?r:r.slice(0,a)}function g(e){n.status.textContent=e}function A(e){return c(e)}function F(e){return c(e)}function I(e){return c(e)}function c(e){let t=document.getElementById(e);if(!t)throw new Error(`Missing element #${e}`);return t}function G(e){return document.getElementById(e)}});Pe();})();
